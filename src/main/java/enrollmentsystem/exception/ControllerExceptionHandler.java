...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleStudentInfoNotFoundException(
		...
		log.error(err, ex);
		return buildErrorResponse(err, HttpStatus.NOT_FOUND);
	}
	 ...
	 * @return
	 */
	@ExceptionHandler(ClassAlreadyEnrolledException.class)
	public ResponseEntity<Object> handleClassAlreadyEnrolledExceptionException(
			ClassAlreadyEnrolledException ex) {

		String errMsg = "The student has already enrolled in this class.";
		log.error(errMsg, ex);
